  ...
  <div class="header">
    <el-row :gutter="10">
      ...
      <el-col :xs="12" :sm="12" :md="4">
        <div class="logo">
          <span class="logo_prefix">SIMRP</span><span class="logo_suffix">原型系统</span>
        </div>
      </el-col>

      <!--Search area-->
      <el-col :xs="12" :sm="12" :md="8" class="hide">
        <div class="search">
          <el-input
            size="small"
      ...
      <!-- header right area-->
      <el-col :xs="24" :sm="12" :md="4" class="hide">
        <div class="website">
          <span>Website:</span>
      ...
      <el-col :xs="8" :sm="8" :md="{span:2,offset:4}" class="hide">
      ...
      <el-col :xs="8" :sm="8" :md="2" class="hide">
